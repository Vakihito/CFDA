...
class QAModel(nn.Module):
    def __init__(self, base_model_list):
        ...
        self.linear_1 = nn.Sequential(
          nn.Linear(self.base_model_hidden_size * (n_clusters + 1), self.default_emb_size),
          nn.PReLU()
        )
    ...
    def forward(self, input_ids, attention_mask):
        ...
        emb_linear_1 = self.linear_1(embeddings_out)
...
df_test_predictions.to_pickle(f"{os.environ['read_data_path']}/test_data_with_preds_cst_concat.pkl")